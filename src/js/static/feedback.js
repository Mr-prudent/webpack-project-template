    ...
    r.forEach(function (t) {
      ...
      $.ajax({
        ...
        data: _objectSpread(
          _objectSpread({}, n),
          {},
          { pageUrl: document.URL, proidlist: a }
        ),
        dataType: "json",
        error: function () {
      ...
      "in-email" == e
        ? "" === n
          ? ((t = !1),
            ...
            toastr.warning($lang.msgInputEmail))
          ...
          : ((t = !1),
            $(this).addClass("input-error"),
            toastr.warning($lang.msgCheckEmail))
        : "in-name" == e
        ? 400 < n.length
          ? (toastr.warning($lang.msgTooLongName),
            $(this).addClass("input-error"),
            (t = !1))
          : $("in-name").removeClass("input-error")
        : "in-content" == e
        ? "" === n
          ? (toastr.warning($lang.msgInputContent),
            $(this).addClass("input-error"),
            (t = !1))
          : 2e3 < n.length
          ? (toastr.warning($lang.msgTooLongContent),
            $(this).addClass("input-error"),
            (t = !1))
          : $(this).removeClass("input-error")
        : "in-title" == e &&
          (340 < n.length
            ? (toastr.warning($lang.msgTooLongTitle),
              $(this).addClass("input-error"),
              (t = !1))
            : $(this).removeClass("input-error")),
      t
